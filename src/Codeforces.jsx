    ...
    <div className="platform-page">
      ...
      <header className="platform-header">
        <div className="platform-title">
          ...
          <h1 className="platform-heading">Codeforces</h1>
        ...
        <div className="platform-filters">
          ...
          <TopicFilter platform="CODEFORCES" selected={topics} onChange={setTopics} />
        </div>
      </header>

      <div className="codeforces-container">
        {isLoading ? (
          <div className="codeforces-list">
            ...
            {problems.map((p, index) => {
              ...
              return (
                <article
                  ...
                  className={`codeforces-card ${difficultyClass} ${isOpen ? "expanded" : ""}`}
                  style={{ "--i": index }}
                >
