    ...
    <div className="platform-page">
      ...
      <header className="platform-header">
        <div className="platform-title">
          ...
          <h1 className="platform-heading">LeetCode</h1>
        ...
        <div className="platform-filters">
          ...
          <TopicFilter platform="LEETCODE" selected={topics} onChange={setTopics} />
        </div>
      </header>
            ...
            {problems.map((p, index) => {
              ...
              return (
                <article
                  ...
                  className={`leetcode-card ${difficultyClass} ${isOpen ? "expanded" : ""}`}
                  style={{ "--i": index }}
                >
